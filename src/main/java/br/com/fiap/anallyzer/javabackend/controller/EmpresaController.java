...
// @PostMapping
// public ResponseEntity<EmpresaResponseDTO> criarEmpresa(@Valid @RequestBody
...
// @GetMapping("/{id}")
// public ResponseEntity<EmpresaResponseDTO> listarEmpresaPorId(@PathVariable
// Long id) {
// EmpresaResponseDTO empresaResponseDTO =
// empresaService.listarEmpresaPorId(id);
// return ResponseEntity.ok(empresaResponseDTO);
// }

// @PutMapping("/{id}")
// public ResponseEntity<EmpresaResponseDTO> atualizarEmpresa(@PathVariable Long
// id,
